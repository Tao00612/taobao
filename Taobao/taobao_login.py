...
class UsernameLogin:
    ...
    def __init__(self, session):
        ...
        # 淘宝用户名
        self.loginId = '13243886080'
        # 淘宝用户名
        self.umidToken = 'd8d9588c49ca3291e50e9e7c1e369a1355bb0f8c'
        # 淘宝关键参数，包含用户浏览器等一些信息，很多地方会使用，从浏览器或抓包工具中复制，可重复使用
        self.ua = '137#'
        # 加密后的密码，从浏览器或抓包工具中复制，可重复使用
        self.password2 = ""
        # 请求超时时间
        self.timeout = 3
        # 起始共用的浏览器登录查找都在这里操作
    ...
    def _verify_password(self):
        ...
        verify_password_data = {
            ...
            'hsiz': '1b3f2a3b69fe64336f1687a966cd9bfc',
            'bizParams':'',
            'style': 'default',
            'appkey': '00000000',
            'from': 'tbTop',
            ...
            'screenPixel': '1280x800',
            'navlanguage': 'zh - CN',
            'navPlatform': 'Win32',
            'appName': 'taobao',
            'appEntrance': 'taobao_pc',
            '_csrf_token': 'tTRJBi27aiPSGCULzftAr6',
            'keepLogin': 'false'
        }
        try:
